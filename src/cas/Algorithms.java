...
public class Algorithms {
	...
	/*
	 * Algorithm collection used throughout the CAS
	 */
	...
	public static Expr exprListToPoly(Func polySequence,Var v,CasInfo casInfo){
	...
	public static Expr multinomial(Expr baseSum,Num expo,CasInfo casInfo) {//returns the binomial expansion
		...
		for(BigInteger[] set : exponentSets){
			...
			for(int i = 0;i<baseSum.size();i++){
				coef = coef.multiply(Algorithms.choose(rem,set[i]));
